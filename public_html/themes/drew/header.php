					...
					<nav id="navigation" class="navigation navbar-collapse collapse navbar-right">
						...
						<ul id="header-nav" class="nav navbar-nav">
							...
							<li class="dropdown dropdown-hover user-menu">
								...
								<img src="<?php if($this->aauth->get_user()->picture !== '') { echo $this->aauth->get_user()->picture; } else{ echo base_url('public_html/uploads/default.png'); }?>" class="user-image" alt="<?= $this->aauth->get_user()->name; ?>"><?= $this->aauth->get_user()->name; ?> <span class="caret"></span></a>
                <ul class="dropdown-menu">
                  <li class="user-header">
                    <img src="<?php if($this->aauth->get_user()->picture !== '') { echo $this->aauth->get_user()->picture; } else{ echo base_url('public_html/uploads/default.png'); }?>" class="img-circle" alt="User Image">
                    <p>
