...
<!-- TEAM
			...
			<form id="vote-id">
				...
				<div class="section-heading text-center"><a href="<?= base_url('voter/'.$this->session->userdata('username')).'/verify';?>" role="button" onclick="getCandidateID" data-toggle="modal" data-target="#pin-modal" class="btn btn-lg btn-default"> Vote </a></div>
